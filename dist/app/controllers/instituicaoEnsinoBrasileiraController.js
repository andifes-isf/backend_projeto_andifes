...
var _instituicaoensinobrasileira = require('../models/instituicaoensinobrasileira'); var _instituicaoensinobrasileira2 = _interopRequireDefault(_instituicaoensinobrasileira);
...
class instituicaoEnsinoBrasileiraController {
    async post(req, res){
        try {
            await _instituicaoensino2.default.post(req, res, 1)
